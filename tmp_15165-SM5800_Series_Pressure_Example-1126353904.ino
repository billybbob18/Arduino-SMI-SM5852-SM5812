...
"BillyBob sent you". A special thanks to David Ezekiel @ Servoflo for helping me find the best possable sensor for my application.
                           ...
                           PIN OUT (Pin 1 labeled)
                               (BOTTOM VIEW)
                                 |-------|
                         (NC)   -|1     8|-    (ANALOG OUT)
                         (GND)  -|2     7|-    (5V)
                         (NC)   -|3     6|-    (NC)
                         (SDA)  -|4     5|-    (SCL)              "connect 10k pullup resistors from SDA and SCL to +5V"
                                 |-------|
*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "Wire.h"
...
////////////////////////////////////////////////////////////////////////////////////////////
//ADJUST THESE VALUES FOR THE TYPE OF SENSOR,THE DESIRED UNIT OF MAESURE, AND THE
//MINIMUM, MAXIMUM, AND ZERO READINGS. THE ZERO READING WILL BE DIFFERENT ON
//EACH INDIVIDUAL SENSOR. MY ZERO VALUE IS 1960, BUT YOURS WILL BE DIFFERENT.
////////////////////////////////////////////////////////////////////////////////////////////
...
// READ THE PRESSURE
{
  ...
  pressRaw = pressMSB << 8;                   // Bit manipulation to move the relevant data to correct positions
  pressLSB = pressLSB << 2;
